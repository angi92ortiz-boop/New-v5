...
function UILibrary:CreateWindow(title)
    ...
    -- CAMBIO: Barra superior ahora es Celeste como en la imagen
    ...
    -- CAMBIO: Texto blanco para contraste sobre la barra celeste
    ...
    -- CAMBIO: Botón cerrar plano y oscuro mate
    ...
    -- CAMBIO: Botón minimizar plano y oscuro mate
    ...
    CloseButton.MouseEnter:Connect(function() TweenService:Create(CloseButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play() end)
    CloseButton.MouseLeave:Connect(function() TweenService:Create(CloseButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(20, 20, 20)}):Play() end)
    ...
    MinimizeButton.MouseEnter:Connect(function() TweenService:Create(MinimizeButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play() end)
    MinimizeButton.MouseLeave:Connect(function() TweenService:Create(MinimizeButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(20, 20, 20)}):Play() end)
    ...
    function window:SwitchToTab(tabToSelect)
        for _, tab in pairs(tabs) do
            ...
            if tab.Button.BackgroundColor3 ~= Color3.fromRGB(20, 20, 20) then
                TweenService:Create(tab.Button, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(20, 20, 20), TextColor3 = Color3.fromRGB(220, 220, 220)}):Play()
            end
        end
    ...
    function window:CreateTab(name)
        local tab = {}
        -- CAMBIO: Pestañas oscuras mate por defecto
        ...
        local tabStroke = CreateElement("UIStroke", {Color = Color3.fromRGB(0, 200, 255), Thickness = 2, Transparency = 1, Parent = tabButton})
        ...
        function tab:CreateButton(text, callback)
            -- CAMBIO: Botones internos oscuros mate con bordes circulares limpios
            ...
            CreateElement("UICorner", {CornerRadius = UDim.new(1, 0), Parent = button})
            local buttonStroke = CreateElement("UIStroke", {Color = Color3.fromRGB(0, 200, 255), Thickness = 2, Transparency = 1, Parent = button})
