...
function UILibrary:CreateWindow(title)
    ...
    local MainFrame = CreateElement("Frame", {
        ...
        BorderSizePixel = 0,
        Position = UDim2.new(0.5, -245, 0.5, -175), -- Ajustado para centrar el nuevo tamaño
        Size = UDim2.new(0, 490, 0, 350), -- Nuevo Tamaño solicitado
    ...
    local TopBar = CreateElement("Frame", {
        Name = "TopBar",
        Parent = MainFrame,
        BackgroundColor3 = Color3.fromRGB(0, 200, 255), -- Barra superior Celeste
        BorderSizePixel = 0,
    ...
    local TitleLabel = CreateElement("TextLabel", {
        ...
        TextColor3 = Color3.fromRGB(255, 255, 255), -- Blanco para resaltar en el celeste
        TextSize = 26,
    ...
    local TabContainer = CreateElement("Frame", {
        ...
        Size = UDim2.new(0, 160, 1, -70) -- Ajustado levemente para el nuevo tamaño de ancho
    })
    ...
    MinimizeButton.MouseButton1Click:Connect(function()
        ...
        if Minimized then
            TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {Size = UDim2.new(0, 490, 0, 70)}):Play()
        else
            TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {Size = UDim2.new(0, 490, 0, 350)}):Play()
        end
    end)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateButton(text, callback)
            local button = CreateElement("TextButton", {
                Parent = page,
                BackgroundColor3 = Color3.fromRGB(0, 200, 255), -- Botones en color celeste por defecto
                BorderSizePixel = 0,
                Size = UDim2.new(1, -20, 0, 50),
                Font = Enum.Font.GothamBold,
                Text = text,
            ...
            local buttonStroke = CreateElement("UIStroke", {Color = Color3.fromRGB(255, 255, 255), Thickness = 2, Transparency = 0.7, Parent = button})
            ...
            button.MouseLeave:Connect(function()
                ...
                TweenService:Create(buttonStroke, TweenInfo.new(0.2), {Transparency = 0.7, Thickness = 2}):Play()
            end)
